...
public class CommentController {
  ...
  public ResponseEntity<Comment> addComment(
      @PathVariable Long campaignId, @RequestBody CommentCreateCommand commentCreateCommand) {
  ...
  private Page<CommentDto> getCommentDtos(Page<Comment> comments, Pageable pageable) {
    List<CommentDto> dtos = comments.get().map(this::getCommentDto).collect(Collectors.toList());
